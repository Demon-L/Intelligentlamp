...
//    [self setTitleViewWithStr:@"所有灯泡"];
    [self setTitleViewWithStr:NSLocalizedString(@"AllLamp", nil)];
...
- (UIBarButtonItem *)rightBarItem{
    ...
    [btn setTitle:NSLocalizedString(@"Edit", nil) forState:UIControlStateNormal];
...
-(void)btnPressed:(id)sender
{
    ...
    model.isNeedSetUp                                     = NO;
        ...
        [self deleteView];
        [button setTitle:NSLocalizedString(@"Cancle", nil) forState:UIControlStateNormal];
    _isEditing                                            = YES;
    }
}
...
-(UIButton *)groupBtn{
    ...
    _groupBtn                                             = [UIButton buttonWithType:UIButtonTypeCustom];
        _groupBtn.titleLabel.font = [UIFont systemFontOfSize:8];
        [_groupBtn setTitle:NSLocalizedString(@"AddToGroup", nil) forState:UIControlStateNormal];
...
- (UIButton *)scenarioBtn{
    ...
    _scenarioBtn                                          = [UIButton buttonWithType:UIButtonTypeCustom];
        [_scenarioBtn setTitle:NSLocalizedString(@"AddToScenario", nil) forState:UIControlStateNormal];
//    _scenarioBtn.titleLabel.font                          = [UIFont systemFontOfSize:10];
    ...
    _scenarioBtn.titleEdgeInsets                          = UIEdgeInsetsMake(25,-18,0,18);
        ...
        _scenarioBtn.titleLabel.font = [UIFont systemFontOfSize:8];
