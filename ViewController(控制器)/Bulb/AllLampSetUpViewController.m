...
- (void)viewDidLoad{
    ...
    [self setTitleViewWithStr:NSLocalizedString(@"LightSet", nil)];
...
- (void)initDataArr{
    NSArray *nameArr                        = @[NSLocalizedString(@"LightNickname", nil),NSLocalizedString(@"LightDescription", nil),NSLocalizedString(@"NightMode", nil),NSLocalizedString(@"SubordinateGroup", nil),NSLocalizedString(@"ApplicationScenarios", nil),NSLocalizedString(@"TimeSwitch", nil),NSLocalizedString(@"TimeDelaySwitch", nil)];
