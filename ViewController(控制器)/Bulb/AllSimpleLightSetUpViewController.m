...
- (void)viewDidLoad{
    ...
    [self setTitleViewWithStr:NSLocalizedString(@"LightControl", nil)];
...
- (UIButton *)hightControl{
    ...
    _hightControl                              = [UIButton buttonWithType:UIButtonTypeCustom];
        ...
        [_hightControl setTitle:NSLocalizedString(@"AdvancedControl", nil) forState:UIControlStateNormal];
...
- (UILabel *)ColorLab{
    ...
    _ColorLab.text                             = NSLocalizedString(@"ColorTemperature", nil);
...
- (UILabel *)lightLab{
    ...
    _lightLab.text                             = NSLocalizedString(@"Drightness", nil);
