...
//    _model                                  = [[UserModel alloc]init];
     [self setTitleViewWithStr:NSLocalizedString(@"Me", nil)];
...
//    NSArray *imageArr                       = @[ @"share",@"light_bulb_description",@"system_upgrade",@"about"];
    NSArray *nameArr                        = @[NSLocalizedString(@"Share", nil),NSLocalizedString(@"Feedback", nil),NSLocalizedString(@"About", nil)];
