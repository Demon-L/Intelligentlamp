...
- (void)viewDidLoad{
    ...
    [self setTitleViewWithStr:NSLocalizedString(@"AddScenario", nil)];
    ...
    [self rightBarButtonItemWithTitle:NSLocalizedString(@"Determine", nil) withClickBtnAction:^{
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.selectionStyle                     = UITableViewCellSelectionStyleNone;
        ...
        switch (indexPath.row) {
            case 0:
    cell.title                              = NSLocalizedString(@"ScenarioName", nil);
                break;

            case 1:
    cell.title                              = NSLocalizedString(@"ScenarioDescribe", nil);
                break;

            case 2:
    cell.title                              = NSLocalizedString(@"TimeSwitch", nil);
                break;

            case 3:
    cell.title                              = NSLocalizedString(@"AddScenario", nil);
                break;
            default:
                break;
        }
