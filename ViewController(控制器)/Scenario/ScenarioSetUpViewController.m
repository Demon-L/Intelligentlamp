...
- (void)initDataArr{
    NSArray *nameArr                        = @[NSLocalizedString(@"ScenarioName", nil),NSLocalizedString(@"ScenarioDescribe", nil),NSLocalizedString(@"TheSceneTiming", nil),NSLocalizedString(@"DeleteScene", nil)];
