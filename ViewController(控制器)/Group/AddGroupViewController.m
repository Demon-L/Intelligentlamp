...
//    [self setTitleViewWithStr:@"创建分组"];
    [self setTitleViewWithStr:NSLocalizedString(@"AddGroup", nil)];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section == 0) {
        ...
        switch (indexPath.row) {
            case 0:
                cell.title = NSLocalizedString(@"GroupName", nil);
                break;
                
            case 1:
                cell.title = NSLocalizedString(@"GroupDescribe", nil);
                break;
                
            case 2:
                cell.title = NSLocalizedString(@"AddGroup", nil);
                break;
