...
- (void)loadControllers{
    ...
    NSArray *selArr                    = [NSArray arrayWithObjects:NSLocalizedString(@"AllLamp", nil),NSLocalizedString(@"Group", nil),NSLocalizedString(@"Scenario", nil),NSLocalizedString(@"Me", nil), nil];
